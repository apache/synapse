...
public class TestCasesMediator {
    ...
    private static int httpPassThruOperatingPort = 8280;
    private static int httpsPassThruOperatingPort = 8243;
    ...
    static HttpResponse apiResourceExecutor(TestCase currentTestCase, String context, String resourceMethod)
        ...
        if (resourceMethod.toUpperCase(Locale.ENGLISH).equals(GET_METHOD)) {
            //set headers and execute
            response = clientConnector.execute(setGetHeaders(currentTestCase, url));

        } else if (resourceMethod.toUpperCase(Locale.ENGLISH).equals(POST_METHOD)) {
            //set headers
        ...
        } else if (resourceMethod.toUpperCase(Locale.ENGLISH).equals(PUT_METHOD)) {
            //set headers
        ...
        } else if (resourceMethod.toUpperCase(Locale.ENGLISH).equals(DELETE_METHOD)) {
        ...
        try {
            for (Map<String, String> property : properties) {
                ...
                if (scope.equals(INPUT_PROPERTY_SCOPE_DEFAULT)) {
                    ...
                    if (headers == null) {
                        Map<String, Object> headersMap = new TreeMap<String, Object>(new Comparator<String>() {
