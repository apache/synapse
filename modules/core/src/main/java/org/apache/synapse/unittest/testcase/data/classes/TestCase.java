...
public class TestCase {
    ...
    private List<Map<String, String>> propertyMap = new ArrayList<Map<String, String>>();
    private List<AssertEqual> assertEquals = new ArrayList<AssertEqual>();
    private List<AssertNotNull> assertNotNull = new ArrayList<AssertNotNull>();
