...
public class FaultMediatorSerializationTest extends AbstractTestCase {
    ...
    private String getXmlOfMediatorForSOAP11(String version, String attrOfCode, String attrOfReasion
        ...
        return "<makefault  version=\"" + version + "\" xmlns=\"http://synapse.apache.org/ns/2010/04/configuration\"><code value=\"" + attrOfCode + "\" xmlns:ns2=\"http://synapse.apache.org/ns/2010/04/configuration\"/><reason value=\"" + attrOfReasion + "\"/>" +
    ...
    private String getXmlOfMediatorForSOAP12(String version, String attrOfCode, String attrOfReasion
        ...
        return "<makefault xmlns=\"http://synapse.apache.org/ns/2010/04/configuration\" version=\"" + version + "\" response=\"" + response + "\"><code value=\"" + attrOfCode + "\" xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\"/><reason value=\"" + attrOfReasion + "\"/>" +
