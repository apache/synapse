...
public interface DeprecationConstants {
    ...
    public static final String CFG_DEPRECATION_FROM_DATE = "fromDate";
    public static final String CFG_DEPRECATION_TO_DATE = "toDate";
    public static final String CFG_DEPRECATION_ENABLED = "enabled";
